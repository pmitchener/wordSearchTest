  ...
  */
  let WordFind = function() {
    ...
    */
    ...
    let allOrientations = ['horizontal','horizontalBack','vertical','verticalUp',
    ...
    */
    let fillPuzzle = function(words, options) {
    ...
    return {
      ...
      */
      newPuzzle: function(words, settings) {
        ...
        let wordList, puzzle, attempts = 0, gridGrowths = 0, opts = settings || {};
        ...
        if (options.fillBlanks) {
          ...
          let extraLettersCount = this.fillBlanks({puzzle, extraLetterGenerator: extraLetterGenerator});
      ...
      newPuzzleLax: function(words, opts) {
        try {
          ...
          for (let i = 0; i < words.length; i++) {
            ...
            wordList.splice(i, 1);
            try {
              let puzzle = this.newPuzzleLax(wordList, opts);
